document.addEventListener("DOMContentLoaded", () => {
    ...
    sldPageUp.addEventListener("input", () => {
        ...
        // Valor > Enlace
        btnPageUp.setAttribute("href", "controller?cmd=abono-listado&op=num&page=" + page);
        btnPageDn.setAttribute("href", "controller?cmd=abono-listado&op=num&page=" + page);
    });
    ...
    lstRowsPageUp.addEventListener("input", () => {
        window.location.href = "controller?cmd=abono-listado&rows-page=" + lstRowsPageUp.value;
    });

    // Select DOWN - Evento Input
    lstRowsPageDn.addEventListener("input", () => {
        window.location.href = "controller?cmd=abono-listado&rows-page=" + lstRowsPageDn.value;
    });
    ...
    btnFilterUp.addEventListener("click", () => {
        window.location.href = "controller?cmd=abono-listado&filter-exp=" + txfFilterUp.value;
    });    
    
    // Botón Filtro DOWN - Evento Click
    btnFilterDn.addEventListener("click", () => {
        window.location.href = "controller?cmd=abono-listado&filter-exp=" + txfFilterDn.value;
    });    
});
