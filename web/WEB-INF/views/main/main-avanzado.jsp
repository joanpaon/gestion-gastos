...
<html lang="es">
  ...
  <head>
    ...
    <!-- Style Sheet Links -->
    <link rel="stylesheet" href="public/css/main/main-avanzado.css" />
  </head>
  ...
  <body>
    ...
    <div id="container">
      ...
      <main>
        <h1>Operaciones Perfil Avanzado</h1>
        <nav>
          ...
          <a href="controller?cmd=perfil-permiso-listado">Permisos de Perfil</a>
          <a href="controller?cmd=usuario-permiso-listado"
             >Permisos de Usuario</a
          >
          <a href="controller?cmd=proyecto-listado">Proyectos</a>
          <a href="controller?cmd=usuario-listado">Usuarios</a>
          <!--<a href="controller?cmd=logout">Cerrar Sesión</a>--> 
        </nav>
      </main>
    ...
    <!-- Application Scripts -->
    <script src="public/js/main/main-basico.js"></script>
  </body>
</html>
