...
<html lang="es">
 ...
 <head>
    ...
    <!-- Style Sheet Links -->
    <link rel="stylesheet" href="public/css/partidas/partida-modificacion.css" /> 
  </head>
  ...
  <body>
    <div id="container">
      ...
      <main>
        <header>
          <h2>Modificación de Partidas</h2>
    ...
    <!-- Application Scripts -->
    <script src="public/js/partidas/partida-modificacion.js"></script>
  </body>
</html>
