  ...
  <body>
    <div id="container">
      ...
      <main>
        ...
        <nav class="botones">
          <a class="btn btn-borrar" href="controller?cmd=proceso-borrado&id=<%= p.getId()%>&op=proceso">Borrar</a>
          <a class="btn btn-cancelar" href="controller?cmd=proceso-consulta&id=<%= p.getId()%>">Cancelar</a>
        </nav>
      </main>
