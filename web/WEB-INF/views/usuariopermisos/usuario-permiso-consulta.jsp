...
<html lang="es">
  ...
  <head>
    ...
    <!-- Style Sheet Links -->
    <link rel="stylesheet" href="public/css/usuariopermisos/usuario-permiso-consulta.css" /> 
  </head>
  ...
  <body>
    <div id="container">
      ...
      <main>
        ...
        <nav class="botones">
          <a class="btn btn-borrar" href="controller?cmd=usuario-permiso-borrado&id=<%= up.getId()%>">Borrar</a>
          <a class="btn btn-modificar" href="controller?cmd=usuario-permiso-modificacion&id=<%= up.getId()%>&op=captura">Modificar</a>
        </nav>
      </main>
    ...
    <script src="public/js/usuariopermisos/usuario-permiso-consulta.js"></script>
  </body>
</html>
