  ...
  <body>
    <div id="container">
      ...
      <main>
        ...
        <nav class="botones">
          <a class="btn btn-borrar" href="controller?cmd=cuota-borrado&id=<%= cuota.getId()%>">Borrar</a>
          <a class="btn btn-modificar" href="controller?cmd=cuota-modificacion&id=<%= cuota.getId()%>&op=captura">Modificar</a>
        </nav>
      </main>
