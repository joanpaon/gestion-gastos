                ...
                if (op == null || op.equals("captura")) {
                    ...
                    switch (perfil) {
                        ...
                        case Perfil.AVANZADO:
                            // Sólo Usuario Actual > Lista de Usuarios
                    ...
                    // Inyectar Datos > JSP
                    request.setAttribute("abono", aIni);
                    ...
                    // Parámetros > Entidad
                    Abono aFin = new Abono(id, proyecto, usuario, info,
                            aIni.getStatus(), aIni.getData(),
                            aIni.getCreatedAt(), aIni.getUpdatedAt());

                    // Entidad > Modificación Registro BD
                    boolean procesoOK = abonoBLL.modificarAbono(aFin);
