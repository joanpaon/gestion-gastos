        ...
        try {
            ...
            if (!UtilesGastos.validarSesion(sesion)) {
                ...
                if (op == null || op.equals("captura")) {
                    ...
                    cIni = procesoBLL.obtenerProceso(id);

                    // Inyección de Datos
                    request.setAttribute("proceso", cIni);
                    ...
                    // Parámetros > Entidad
                    Proceso cFin = new Proceso(id, nombre, info,
                            cIni.getStatus(), cIni.getData(),
                            cIni.getCreatedAt(), cIni.getUpdatedAt());

                    // Ejecutar Operación
                    boolean procesoOK = procesoBLL.modificarProceso(cFin);
