        ...
        try {
            ...
            if (!UtilesGastos.validarSesion(sesion)) {
                ...
                if (op == null || op.equals("captura")) {
                    ...
                    uIni = usuarioBLL.obtenerUsuario(id);

                    // Obtener Lista de Perfiles
                    List<Perfil> lista = perfilBLL.obtenerPerfiles();

                    // Inyectar Datos > JSP
                    request.setAttribute("usuario", uIni);
                    ...
                    // Parámetros > Entidad
                    Usuario uFin = new Usuario(id, user, pass, email,
                            avatar, perfil, info,
                            uIni.getStatus(), uIni.getData(),
                            uIni.getCreatedAt(), uIni.getUpdatedAt());

                    // Ejecutar Operación
                    boolean procesoOK = usuarioBLL.modificarUsuario(uFin);
