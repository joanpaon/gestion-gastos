 ...
 */
public final class CommandPartidaBorrado extends Command {
        ...
        try {
            ...
            if (!UtilesGastos.validarSesion(sesion)) {
                ...
                if (op == null || op.equals("captura")) {
                    ...
                    Partida g = partidaBLL.obtenerPartida(id);

                    // Enlaza Datos > JSP
                    request.setAttribute("partida", g);

                    // Confirmar Borrado
                    page = "partidas/partida-borrado";
                } else if (op.equals("proceso")) {
                    // ID > Registro Borrado - true | false
                    boolean operacionOK = partidaBLL.borrarPartida(id);
