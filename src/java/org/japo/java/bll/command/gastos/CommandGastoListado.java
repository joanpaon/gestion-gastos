...
public final class CommandGastoListado extends Command {
    ...
    private static final String TABLA = "gastos";
    ...
    private static final String[] CAMPOS_LISTADO
            = {"gastos.id", "gastos.info", "gastos.fecha", "gastos.importe"};
    ...
    private static final String PAGINA_PROCESO = "gastos/gasto-listado";
