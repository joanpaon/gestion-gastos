 ...
 */
public final class CommandGastoBorrado extends Command {
    ...
    try {
      ...
      if (!UtilesGastos.validarSesion(sesion)) {
        ...
        if (op == null || op.equals("captura")) {
          // ID Entidad > Entidad
          EntityGasto gasto = gastoDAL.obtenerGasto(id);

          // Inyecta Datos > JSP
          request.setAttribute("gasto", gasto);

          // Confirmar Borrado
          page = "gastos/gasto-borrado";
        } else if (op.equals("proceso")) {
          // ID > Registro Borrado - true | false
          boolean operacionOK = gastoDAL.borrarGasto(id);
