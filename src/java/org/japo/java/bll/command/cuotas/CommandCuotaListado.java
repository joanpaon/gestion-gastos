...
public final class CommandCuotaListado extends Command {
    ...
    private static final String TABLA = "cuotas";
    ...
    private static final String PARAMETROS_LISTADO_SESION = "parametros-listado-cuotas";
        ...
        try {
            ...
            if (!UtilesGastos.validarSesion(sesion)) {
                ...
                if (adminBLL.validarAccesoComando(getClass().getSimpleName())) {
                    ...
                    String[] camposListado = {"cuotas.id", "cuotas.nombre", "cuotas.info"};
